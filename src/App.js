...
function App() {
  ...
  const [todo, setTodo] = useState(
    JSON.parse(localStorage.getItem("todo")) || [
      ...
      { id: 4, order: 2, value: "10 minutes meditation", checked: false },
      { id: 3, order: 3, value: "Read for 1 hour", checked: false },
      { id: 2, order: 4, value: "Pick up groceries", checked: false },
      {
        id: 1,
        order: 5,
          ...
          {todo.length ? (
            <>
              ...
              <div className="filters">
                ...
                <button className="filters-btn" onClick={clearComplited}>
                  {" "}
                  Clear Complited{" "}
                </button>
              </div>
