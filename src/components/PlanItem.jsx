...
const PlanItem = (props) => {
  return (
    <div
      className="plan-box"
      onDragStart={(e) => props.dragStartHandler(e, props.todoItem)}
    ...
    >
      ...
      <div className={`plan-text ${props.checked ? "checked" : "unchecked"}`}>
        {props.text}
      </div>
      <button
        className="plan-delete"
        onClick={(event) => props.deleteItem(event, props.id)}
      >
